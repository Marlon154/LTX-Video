...
from ltx_video.pipelines.pipeline_semantic_guidance_ltx_video import SemanticLTXVideoPipeline
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Editing prompt to guide generation",
    )
    ...
    pipeline = SemanticLTXVideoPipeline(**submodel_dict)
    if torch.cuda.is_available():
